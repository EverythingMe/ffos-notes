//
// Autogenerated by Thrift Compiler (0.5.0-en-271777)
//
...
var me = this;
try {
  this.send_checkVersion(clientName, edamVersionMajor, edamVersionMinor, function() { callback.onSuccess(me.recv_checkVersion()); });
} catch(e) {
...
var me = this;
try {
this.send_getBootstrapInfo(locale, function() { callback.onSuccess(me.recv_getBootstrapInfo()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_authenticate(username, password, consumerKey, consumerSecret, function() { callback.onSuccess(me.recv_authenticate()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_authenticateToBusiness(authenticationToken, function() { callback.onSuccess(me.recv_authenticateToBusiness()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_refreshAuthentication(authenticationToken, function() { callback.onSuccess(me.recv_refreshAuthentication()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getUser(authenticationToken, function() { callback.onSuccess(me.recv_getUser()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getPublicUserInfo(username, function() { callback.onSuccess(me.recv_getPublicUserInfo()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getPremiumInfo(authenticationToken, function() { callback.onSuccess(me.recv_getPremiumInfo()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNoteStoreUrl(authenticationToken, function() { callback.onSuccess(me.recv_getNoteStoreUrl()); });
} catch(e) {
callback.onFailure(e);
}
};
