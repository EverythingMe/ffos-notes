...
NoteStore_findRelatedNotes_args.prototype.write = function(output) {
  ...
  if (this.maxNotes !== null && this.maxNotes !== undefined) {
    output.writeFieldBegin('maxNotes', Thrift.Type.I32, 3);
    output.writeI32(this.maxNotes);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
...
var me = this;
try {
this.send_createNote(authenticationToken, note, function() { callback.onSuccess(me.recv_createNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
NoteStoreClient.prototype.findRelatedNotes = function(authenticationToken, query, maxNotes, callback) {
var me = this;
try {
this.send_findRelatedNotes(authenticationToken, query, maxNotes, function() { callback.onSuccess(me.recv_findRelatedNotes()); });
} catch(e) {
callback.onFailure(e);
}
};

NoteStoreClient.prototype.send_findRelatedNotes = function(authenticationToken, query, maxNotes, callback) {
