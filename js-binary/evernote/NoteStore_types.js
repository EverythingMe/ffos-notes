...
RelatedNotesExampleNote = function(args) {
  this.guid = null;
  if (args) {
    if (args.guid !== undefined) {
      this.guid = args.guid;
...
RelatedNotesExampleNote.prototype = {};
RelatedNotesExampleNote.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
RelatedNotesExampleNote.prototype.write = function(output) {
  output.writeStructBegin('RelatedNotesExampleNote');
  if (this.guid !== null && this.guid !== undefined) {
    output.writeFieldBegin('guid', Thrift.Type.STRING, 1);
    output.writeString(this.guid);
    output.writeFieldEnd();
...
RelatedNotesQuery.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.exampleNote = new RelatedNotesExampleNote();
...
RelatedNotesQuery.prototype.write = function(output) {
  ...
  if (this.exampleNote !== null && this.exampleNote !== undefined) {
    output.writeFieldBegin('exampleNote', Thrift.Type.STRUCT, 1);
    this.exampleNote.write(output);
    output.writeFieldEnd();
  }
  if (this.exampleText !== null && this.exampleText !== undefined) {
